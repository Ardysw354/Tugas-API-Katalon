...
def response = WS.sendRequest(findTestObject('Tugas API - Katalon Mock API/UPDATE User', [('first_name') : randomUsername, ('last_name') : 'sw'
            , ('username') : 'ardy_edit', ('job_position') : 'asdsadas', ('job_level') : 'asdsadasa']))
